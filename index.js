...
var wordList = ["Thor", "Loki", "Modok", "Ultron", "Vision",  "Electro", "Thanos", "Punisher", "Rhino", "Deadpool", "Groot","Antman"];
var randomWord;
var someWord;

// "BlackWidow", "ScarletWitch","CaptainAmerica","WinterSoldier", "IronMan", "SpiderMan",
...
var lettersAlreadyGuessedList = "_";
var lettersAlreadyGuessedListArray = [];
for (var i = 0; i < userGuessedCorrectly.length; i++) {
    userGuess.push('_');
}
...
figlet("Hangman Game", function(err, data) {
    ...
    console.log(gameTextColor("Theme is... Marvel Heroes and Villains."));
    //Game instructions.
    var howToPlay = 
    "==========================================================================================================" + "\r\n" +
    "How to play" + "\r\n" +
    "==========================================================================================================" + "\r\n" +
    "To guess a letter, press any letter key on the keyboard followed by the return or enter key." + "\r\n" +
    "If your guess is correct it will appear in the correct guesses field and the 'Letters Guessed Box'.  However,as of now, the first letter will appear to the left side of field if next letter appears before that letter it will push that letter to the right." + "\r\n" +
    "If incorrect, the letter you guessed does not appear in the word and appears in the 'Letters Guessed Box'." + "\r\n" + 
    "Incorrect guesses decreases your guess counter." + "\r\n" +
    "You win if you guess the word before you run out of guesses." + "\r\n" +
    "If you run out of guesses before discovering the word, you'll lose and can choose to restart or end game." + "\r\n" +
    "===========================================================================================================" + "\r\n" +
...
function guessLetter(){
	...
	if (slotsFilledIn < someWord.letters.length || guessCounter > 0) {
	inquirer.prompt([
  {
    name: "letter",
	...
	//If user entered a letter that was not already guessed...
		...
		//Else if user guessed incorrectly...
			...
			guessCounter--;
			console.log(gameTextColor("You have " + guessCounter + " guesses left."));
			console.log(gameTextColor("====================================================================="));
			//After each letter guess, check if the user won or lost.
			checkIfUserWon();
		}
...
function checkIfUserWon() {
	...
	//else if the number of slots/underscores that are filled in with a letter equals the number of letters in the word, the user won.
		...
		console.log(gameTextColor("====================================================================="));
		console.log(correct("YOU WON! YOU'RE A CHAMPION!"));
